...
// All services with image descriptions
const services = [
  {
  ...
  },
  {
    ...
    imageName: "hotel-reservation.jpg",
    variant: 'right' as const,
  },
  {
    title: "Travel Guides",
...
export function ServicesContent() {
  return (
    <>
      {/* SECTION 1: Premium Header with Left Content */}
      <section className="relative pt-0 lg:pt-8 bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900 overflow-hidden">
        <motion.div
          ...
          <div className="grid lg:grid-cols-5 items-center gap-12">
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <p className="text-yellow-400 text-sm uppercase tracking-[0.3em]">Since 2009</p>
                  <p className="text-white/70 text-sm">Pioneering Excellence</p>
                </div>
              </div>
              ...
              <div className="relative pl-8">
                <div className="absolute left-0 top-0 bottom-0 w-1 bg-yellow-400/30" />
            ...
            >
              <h1 className={`${playfair.className} text-6xl lg:text-8xl font-bold text-white leading-tight mb-6`}>
                Curated Journeys
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="space-y-32">
            {services.map((service, index) => (
              ...
              >
                <div className={cn(
                  "grid lg:grid-cols-2 gap-16 items-center min-h-[600px]",
                  ...
                  <div className={cn(
                    ...
                    <div className="flex items-center gap-4 mb-4">
                      <span className="text-yellow-400 text-sm uppercase tracking-[0.2em]">Service {index + 1}</span>
                    </div>
                    <h3 className={`${playfair.className} text-4xl lg:text-5xl font-bold text-white`}>
                      {service.title}
                    </h3>
                  ...
                  {/* Image */}
                  <div className={cn(
                    "relative h-[500px] rounded-3xl overflow-hidden shadow-2xl shadow-black/30",
      ...
      <section className="relative py-32 bg-gradient-to-br from-green-800 to-amber-700 overflow-hidden">
        <motion.div
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {stats.map((stat, index) => (
              <motion.div
                ...
                className="text-center p-8 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all duration-300"
              >
                <div className="flex justify-center mb-4">
                  <div className="w-20 h-20 rounded-full bg-yellow-400 flex items-center justify-center">
                    <stat.Icon className="w-10 h-10 text-green-900" />
                  </div>
                </div>
                <motion.div
                  className={`${playfair.className} text-4xl lg:text-5xl font-bold text-yellow-400 mb-2`}
                >
                  {stat.number}
                </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            {processSteps.map((step, index) => (
              <motion.div
                ...
                className="text-center p-8 rounded-3xl bg-neutral-700/50 backdrop-blur-sm border border-neutral-600 hover:bg-neutral-700 transition-all duration-300"
              >
                <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-yellow-400 flex items-center justify-center text-2xl font-bold text-neutral-900">
                  {step.id}
                </div>
