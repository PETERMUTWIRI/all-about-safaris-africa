...
import { ArrowRight, Shield, Award, Users, Globe, Trees, Heart, Trophy, Star, ChevronDown, MessageCircle, Facebook, Instagram } from 'lucide-react';
...
export function AboutContent() {
  ...
  return (
    <>
      ...
      <section className="py-32 bg-neutral-900">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h5 className="text-yellow-400 text-sm uppercase tracking-[0.3em] mb-4">Our Mission</h5>
              ...
              <Link href="/services">
                <Button className="bg-yellow-400 hover:bg-orange-500 text-neutral-900 font-bold px-8 py-4 rounded-full text-lg transition-all duration-300 hover:scale-105">
                  Our Services
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {team.map((member, index) => (
              ...
              >
                <div className="w-32 h-32 mx-auto mb-6 rounded-full overflow-hidden border-4 border-yellow-400 shadow-2xl">
                  <Image
                    src={member.image}
                    alt={member.name}
                    width={128}
      ...
      <section className="py-32 bg-neutral-900">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h5 className="text-yellow-400 text-sm uppercase tracking-[0.3em] mb-4">Our Commitment</h5>
              <h2 className={`${playfair.className} text-5xl lg:text-6xl font-bold text-white mb-8`}>
                Sustainable Tourism
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <Trees className="w-8 h-8 text-yellow-400 mt-1" />
                  <div>
                    <h4 className="text-white font-bold text-lg">Conservation First</h4>
                    <p className="text-neutral-400">Supporting wildlife protection in 15+ reserves across East Africa</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <Heart className="w-8 h-8 text-yellow-400 mt-1" />
                  <div>
                    <h4 className="text-white font-bold text-lg">Community Impact</h4>
                    <p className="text-neutral-400">Employing 200+ local staff and supporting 30+ community projects</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <Globe className="w-8 h-8 text-yellow-400 mt-1" />
                  <div>
                    <h4 className="text-white font-bold text-lg">Carbon Neutral</h4>
                    <p className="text-neutral-400">Offsetting 100% of travel emissions through verified programs</p>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <section className="relative py-32 bg-gradient-to-b from-neutral-800 to-neutral-900 overflow-hidden">
        <motion.div
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h2 className={`${playfair.className} text-6xl lg:text-8xl font-bold text-white`}>
              Awards That
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <motion.div
                ...
                className="text-center p-8 rounded-3xl bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all duration-300"
              >
                ...
                <p className="text-neutral-400 text-sm">{item.year}</p>
              </motion.div>
            ))}
          </div>
        </div>
            ...
            {timeline.map((item, index) => (
              ...
              >
                <div className={cn(
                  ...
                  <div className="inline-block bg-neutral-800 p-6 rounded-2xl border border-neutral-700 hover:border-yellow-400 transition-all duration-300">
                    <span className="text-yellow-400 text-3xl font-bold block mb-2">
                      {item.year}
                    </span>
                ...
                <div className="absolute left-1/2 -translate-x-1/2 w-6 h-6 bg-yellow-400 rounded-full border-4 border-neutral-900 shadow-2xl" />
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="relative py-40 bg-gradient-to-br from-green-900 via-amber-800 to-orange-700 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h2 className={`${playfair.className} text-7xl lg:text-9xl font-bold text-white mb-8`}>
              Your Safari
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
              <Link href="https://wa.me/254700064857" target="_blank">
                <Button className="bg-yellow-400 hover:bg-orange-500 text-neutral-900 font-bold px-12 py-6 rounded-full text-xl transition-all duration-300 hover:scale-105 shadow-2xl">
                  Start Your Journey
                  <MessageCircle className="w-6 h-6 ml-2" />
                </Button>
              </Link>
              <Link href="/services">
                <Button variant="outline" className="border-white text-white hover:bg-white hover:text-neutral-900 font-bold px-12 py-6 rounded-full text-xl transition-all duration-300">
