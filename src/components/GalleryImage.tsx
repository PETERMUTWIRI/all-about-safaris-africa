...
export function GalleryImage({ image, onOpen }: GalleryImageProps) {
  ...
  return (
    <motion.div
      ...
      className="group relative overflow-hidden rounded-xl md:rounded-2xl bg-neutral-800 border border-neutral-700 cursor-pointer"
        ...
        {isHovered && (
          ...
          >
            <div className="space-y-2">
              ...
              <motion.button
                className="w-full mt-2 bg-yellow-400 hover:bg-orange-500 text-neutral-900 text-xs font-bold py-2 px-3 rounded-full transition-all duration-300 flex items-center justify-center gap-1"
