...
export function BookingForm() {
  ...
  return (
    <section ref={ref} className="relative py-32 bg-gradient-to-br from-neutral-900 to-neutral-800 overflow-hidden">
      ...
      >
        <Link href="https://wa.me/254700064857" target="_blank" rel="noopener noreferrer">
          ...
          >
            <div className="space-y-8">
              <motion.h5
                ...
                className="text-[var(--savanna-gold)] text-sm font-semibold tracking-widest uppercase"
              >
              ...
              >
                Book Your
                <span className="block text-[var(--savanna-gold)]">Adventure</span>
              </motion.h2>
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 bg-[var(--savanna-gold)] rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <AnimatePresence mode="wait">
                {isSuccess && (
                  ...
                  >
                    ...
                    >
                      <div className="w-20 h-20 bg-[var(--savanna-gold)] rounded-full flex items-center justify-center mb-6">
                    ...
                    >
                      Your adventure awaits. Our safari expert will contact you within 24 hours to finalize your journey.
                    </motion.p>
                    <motion.button
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ delay: 0.8 }}
                      className="px-8 py-3 bg-[var(--savanna-gold)] hover:bg-[var(--earth-ochre)] text-neutral-900 font-bold rounded-full transition-colors"
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <motion.div custom={1} variants={fieldVariants} initial="initial" animate={isInView ? "animate" : "initial"}>
                    <Label htmlFor="name" className="text-white mb-2 flex items-center gap-2">
                      <User className="w-4 h-4 text-[var(--savanna-gold)]" />
                      Full Name
                    </Label>
                    <Input id="name" placeholder="John Doe" value={formData.name} onChange={(e) => handleChange('name', e.target.value)} className="bg-neutral-900 border-neutral-700 text-white placeholder:text-neutral-600 focus:border-[var(--savanna-gold)] transition-colors" required />
                  </motion.div>
                  ...
                  <motion.div custom={2} variants={fieldVariants} initial="initial" animate={isInView ? "animate" : "initial"}>
                    <Label htmlFor="email" className="text-white mb-2 flex items-center gap-2">
                      <Mail className="w-4 h-4 text-[var(--savanna-gold)]" />
                      Email Address
                    </Label>
                    <Input id="email" type="email" placeholder="john@example.com" value={formData.email} onChange={(e) => handleChange('email', e.target.value)} className="bg-neutral-900 border-neutral-700 text-white placeholder:text-neutral-600 focus:border-[var(--savanna-gold)] transition-colors" required />
                  </motion.div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <motion.div custom={3} variants={fieldVariants} initial="initial" animate={isInView ? "animate" : "initial"}>
                    <Label htmlFor="date" className="text-white mb-2 flex items-center gap-2">
                      <Calendar className="w-4 h-4 text-[var(--savanna-gold)]" />
                      Preferred Date
                    </Label>
                    <Input id="date" type="date" value={formData.date} onChange={(e) => handleChange('date', e.target.value)} className="bg-neutral-900 border-neutral-700 text-white focus:border-[var(--savanna-gold)] transition-colors" required />
                  </motion.div>
                  ...
                  <motion.div custom={4} variants={fieldVariants} initial="initial" animate={isInView ? "animate" : "initial"}>
                    <Label htmlFor="destination" className="text-white mb-2 flex items-center gap-2">
                      <MapPin className="w-4 h-4 text-[var(--savanna-gold)]" />
                      Destination
                    </Label>
                    {/* ✅ FIXED: Explicitly type 'value' as string */}
                    <Select value={formData.destination} onValueChange={(value: string) => handleChange('destination', value)} required>
                      <SelectTrigger className="bg-neutral-900 border-neutral-700 text-white focus:border-[var(--savanna-gold)]">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <motion.div custom={5} variants={fieldVariants} initial="initial" animate={isInView ? "animate" : "initial"}>
                    <Label htmlFor="persons" className="text-white mb-2 flex items-center gap-2">
                      <Users className="w-4 h-4 text-[var(--savanna-gold)]" />
                      Number of Travelers
                    </Label>
                    {/* ✅ FIXED: Explicitly type 'value' as string */}
                  ...
                  <motion.div custom={6} variants={fieldVariants} initial="initial" animate={isInView ? "animate" : "initial"}>
                    <Label htmlFor="categories" className="text-white mb-2 flex items-center gap-2">
                      <Clock className="w-4 h-4 text-[var(--savanna-gold)]" />
                      Experience Level
                    </Label>
                    {/* ✅ FIXED: Explicitly type 'value' as string */}
                ...
                <motion.div custom={7} variants={fieldVariants} initial="initial" animate={isInView ? "animate" : "initial"}>
                  <Label htmlFor="message" className="text-white mb-2 flex items-center gap-2">
                    <MessageSquare className="w-4 h-4 text-[var(--savanna-gold)]" />
                    Special Requests
                  </Label>
                  <Textarea id="message" placeholder="Tell us about your dream adventure..." value={formData.message} onChange={(e) => handleChange('message', e.target.value)} className="bg-neutral-900 border-neutral-700 text-white placeholder:text-neutral-600 focus:border-[var(--savanna-gold)] transition-colors min-h-[120px]" />
                </motion.div>

                {/* Submit Button */}
                <motion.div custom={8} variants={fieldVariants} initial="initial" animate={isInView ? "animate" : "initial"} className="pt-6">
                  <Button type="submit" disabled={isSubmitting} className="w-full py-6 bg-[var(--savanna-gold)] hover:bg-[var(--earth-ochre)] text-neutral-900 font-bold text-lg rounded-full transition-all duration-300 shadow-2xl hover:shadow-[var(--savanna-gold)]/30">
                    {isSubmitting ? (
